...
public class DeptController {
    ...
    public ResponseBo getDeptTree() {
        try {
            ...
            log.error("获取机构失败", e);
            return ResponseBo.error("获取机构失败！");
        }
    }
    ...
    public ResponseBo deptExcel(Dept dept) {
        try {
            ...
            return FileUtil.createExcelByPOIKit("机构表", list, Dept.class);
        } catch (Exception e) {
            log.error("导出机构信息Excel失败", e);
    ...
    public ResponseBo deptCsv(Dept dept) {
        try {
            List<Dept> list = this.deptService.findAllDepts(dept);
            return FileUtil.createCsv("机构表", list, Dept.class);
        } catch (Exception e) {
            log.error("获取机构信息Csv失败", e);
